...
public class testController {
    ...
    public ResponseEntity<List<CanonicalResponseDto<CanonicalTransactionDto>>> validateTransaction(
        ...
        List<CanonicalResponseDto<CanonicalTransactionDto>> results = ruleOrchestratorService.validate(transactionDto);
        routeEngineService.publishToPostValidation(transactionDto);
